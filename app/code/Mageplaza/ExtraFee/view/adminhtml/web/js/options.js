    ...
    return function (config) {
        var attributeOption = {
            ...
            ignoreValidate: function () {
                jQuery('#edit_form').data('validator').settings.forceIgnore =
                    '.ignore-validate input, .ignore-validate select, .ignore-validate textarea';
            },
        ...
        }, applyType, options, checkOptionsShow;
        ...
        applyType        = jQuery('#rule_apply_type');
