...
namespace Mageplaza\ExtraFee\Magewire\Checkout\Shipping;
...
if (!class_exists(\Magewirephp\Magewire\Component::class)) {
    eval('namespace Magewirephp\Magewire; class Component {}');
}

/**
 * Class ExtraFee
 * @package Mageplaza\ExtraFee\Magewire\Checkout\Shipping
 */
