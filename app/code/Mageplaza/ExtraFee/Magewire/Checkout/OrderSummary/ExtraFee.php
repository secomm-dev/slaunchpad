...
namespace Mageplaza\ExtraFee\Magewire\Checkout\OrderSummary;
...
if (!class_exists(Component::class)) {
    class_alias(ClassFallback::class, 'Magewirephp\Magewire\Component');
}

/**
 * Class ExtraFee
 * @package Mageplaza\ExtraFee\Magewire\Checkout\OrderSummary
 */
