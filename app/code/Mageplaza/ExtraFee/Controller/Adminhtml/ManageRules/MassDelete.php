    ...
    public function execute()
    {
        ...
        foreach ($collection as $rule) {
            try {
                ...
                $this->_getSession()
                    ->addException($e, __('Something went wrong while deleting for %1.', $rule->getName()));
            }
        }

        if ($ruleDeleted) {
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been deleted.', $ruleDeleted));
        }
