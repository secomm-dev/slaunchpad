        ...
        return _.extend(
            Validator, {
                ...
                oscValidateAddressData: function (field, address) {
                    ...
                    $.each(
                        self.getValidationRules(), function (carrier, fields) {
                            if (fields.hasOwnProperty(field)) {
                                var missingValue = false;
                                $.each(
                                    fields, function (key, rule) {
                ...
                isFieldExisted: function (field) {
                    var result = false;
                    $.each(
                        observedElements, function (key, element) {
                                ...
                                if (self.isFormInline()) {
                                    ...
                                    if ($.inArray(element.index, observableElements) !== -1 && self.oscValidateAddressData(element.index, addressFlat)) {
                                        ...
                                        if (configLoading && configLoading.refresh_page !== '1') {
                                            self.validateAddressTimeout = setTimeout(
                                                function () {
