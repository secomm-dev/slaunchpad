...
/**
 * Class ColumnsColspan
 * @package Mageplaza\OscUltimate\Block\Adminhtml\Layout\ManageBlock
 */
class ColumnsColspan extends AbstractBlock
{
    const BLOCK_ID = '3columns-colspan';

    /**
     * @var string
     */
    protected $_template = 'Mageplaza_OscUltimate::block/manageBlock/columnsColspan.phtml';
