 ...
 */
class ColumnsFloat extends AbstractBlock
{
    const BLOCK_ID = '2columns-floating';

    /**
     * @var string
     */
    protected $_template = 'Mageplaza_OscUltimate::block/manageBlock/columnsFloat.phtml';
