    ...
    return Element.extend({
        ...
        processData: function (data) {
            ...
            _.each(items, function (record, index) {
                ...
                totalEmailAbandonedSent += parseFloat(record['total_email_abandoned_sent'] ? record['total_email_abandoned_sent'] : 0);
                ...
                if (typeof range !== "undefined") {
                    ...
                    range[record['period_time']].total_email_abandoned_sent = record['total_email_abandoned_sent'] ? record['total_email_abandoned_sent'] : 0;
            ...
            if (typeof range !== "undefined") {
                _.each(range, function (value, key) {
                    ...
                    totalEmailAbandonedSentData.push(self.convertValue(value['total_email_abandoned_sent'] ? value['total_email_abandoned_sent'] : 0));
