...
class DescriptionLength extends AbstractCheck
{
    ...
    public function getCheckResult(UrlInterface $url): array
    {
        ...
        if ($len === 0) {
            $score = -10;
            $msg   = (string)__('Empty meta description');
        } elseif ($len <= 50) {
            $score = 3;
            $msg   = (string)__('Meta description too short');
        } elseif ($len < 110) {
            $score = 6;
            $msg   = (string)__('Meta description too short');
        } elseif ($len <= 160) {
            ...
            $score = 6;
            $msg   = (string)__('Meta description too long');
        } else {
            $score = 3;
            $msg   = (string)__('Meta description too long');
        }
    ...
    {
        return (string)__("Meta description length");
    }

    public function getGridColumnLabel(): string
    {
        return (string)__('Meta description');
    }
