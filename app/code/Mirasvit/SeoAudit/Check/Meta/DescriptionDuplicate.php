...
class DescriptionDuplicate extends AbstractCheck
{
    ...
    public function getCheckResult(UrlInterface $url): array
    {
        ...
        return [
            ...
            CheckResultInterface::MESSAGE => (string)__('Duplicate of meta description'),
        ];
    }
    ...
    {
        return (string)__("Duplicate of meta description");
    }

    public function getGridColumnLabel(): string
    {
        return (string)__('URLs with the same meta descriptions');
    }
    ...
    public function getValueGridOutput(string $value): string
    {
        ...
        if (!$value[UrlInterface::META_DESCRIPTION]) {
            return (string)__('The page doesn\'t have a meta description');
        } elseif (!count($value['ids'])) {
            return (string)__('No pages with the identical meta description found');
        }
