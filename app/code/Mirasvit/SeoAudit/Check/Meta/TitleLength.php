...
class TitleLength extends AbstractCheck
{
    ...
    public function getCheckResult(UrlInterface $url): array
    {
        ...
        if ($len === 0) {
            $score = -10;
            $msg   = (string)__('Empty meta title');
        } elseif ($len <= 20) {
            $score = 3;
            $msg   = (string)__('Meta title too short');
        } elseif ($len < 50) {
            $score = 6;
            $msg   = (string)__('Meta title too short');
        } elseif ($len <= 70) {
            ...
            $score = 6;
            $msg   = (string)__('Meta title too long');
        } else {
            $score = 3;
            $msg   = (string)__('Meta title too long');
        }
    ...
    {
        return (string)__("Meta title length");
    }

    public function getGridColumnLabel(): string
    {
        return (string)__('Meta title');
    }
