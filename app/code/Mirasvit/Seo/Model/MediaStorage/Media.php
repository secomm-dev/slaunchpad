...
class Media implements AppInterface
{
    ...
    public function __construct(
        ...
        if (!empty($mediaDirectory)) {
            ...
            $realPath = $file->getRealPath($mediaDirectory);
            $this->mediaDirectoryPath = str_replace('\\', '/', is_string($realPath) ? $realPath : $mediaDirectory);
        }
    ...
    {
        return preg_replace('|^.*((?:/[^/]+){3})$|', '$1', $resizedImagePath) ?? $resizedImagePath;
    }
