...
class Validate extends \Magento\Rule\Model\Condition\AbstractCondition
{
    ...
    protected function _prepareValueOptions()
    {
        ...
        if ($this->getAttribute() === 'attribute_set_id') {
            ...
            if ($attributeObject instanceof \Magento\Eav\Model\Entity\Attribute\AbstractAttribute && $attributeObject->usesSource()) {
    ...
    public function collectValidatedAttributes($productCollection)
    {
        ...
        if (!in_array($attribute, ['category_ids', 'qty', 'price_diff', 'percent_discount'])) {
            if ($this->getAttributeObject() instanceof \Magento\Catalog\Model\ResourceModel\Eav\Attribute && $this->getAttributeObject()->isScopeGlobal()) {
                $attributes = $this->getRule()->getCollectedAttributes();
                $attributes[$attribute] = true;
                $this->getRule()->setCollectedAttributes($attributes);
                $productCollection->addAttributeToSelect($attribute);
            } elseif (is_object($productCollection) && method_exists($productCollection, 'getAllAttributeValues')) {
