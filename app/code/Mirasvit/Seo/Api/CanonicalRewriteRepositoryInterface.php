...
{
    /**
     * Get canonical rewrite by ID.
     *
     * @param int $canonicalRewriteId
    ...
    /**
     * Get list of canonical rewrites matching the given search criteria.
     *
     * @param \Magento\Framework\Api\SearchCriteriaInterface $searchCriteria
     * @return \Mirasvit\Seo\Api\Data\CanonicalRewriteSearchResultsInterface
     */
    public function getList(SearchCriteriaInterface $searchCriteria): CanonicalRewriteSearchResultsInterface;

    /**
     * Save canonical rewrite. If canonicalRewriteId is provided, performs a load-then-merge update; otherwise creates a new record.
     *
     * @param \Mirasvit\Seo\Api\Data\CanonicalRewriteInterface $canonicalRewrite
     * @param int|null $canonicalRewriteId
     * @return \Mirasvit\Seo\Api\Data\CanonicalRewriteInterface
     * @throws \Magento\Framework\Exception\NoSuchEntityException
    ...
    /**
     * Delete canonical rewrite by ID.
     *
     * @param int $canonicalRewriteId
     * @return bool
     * @throws \Magento\Framework\Exception\NoSuchEntityException
