...
{
    private const DEFAULT_BUTTON_LABEL = 'Add cookie';
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('Mirasvit_Seo::system/config/cookie.phtml');
        }
        return $this;
    }
    ...
    {
        $cookieButtonLabel = $this->cookieData->getButtonLabel() ?: self::DEFAULT_BUTTON_LABEL;

        $this->addData(
            [
                'button_label' => __($cookieButtonLabel),
