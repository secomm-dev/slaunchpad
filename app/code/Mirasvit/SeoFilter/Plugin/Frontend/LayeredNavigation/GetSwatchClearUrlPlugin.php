...
use Mirasvit\LayeredNavigation\Block\Renderer\SwatchRenderer;
use Mirasvit\SeoFilter\Service\FriendlyUrlService;

/**
 * @see SwatchRenderer::getSeparator()
 */
class GetSwatchClearUrlPlugin
{
    private $config;
    ...
    public function afterGetAttributeClearUrl(SwatchRenderer $subject, string $result, string $attributeCode)
    {
