    ...
    public function afterDispatch($subject, $response)
    {
        ...
        if ($content->getMetaTitle() && method_exists($this->pageConfig, 'setMetaTitle')) {
            try {
                ...
                // intentional no-op: setMetaTitle is a version-guarded (2.3+) optional setter; a
                // failure here must not break page dispatch, and the other meta tags still apply.
            }
        }
