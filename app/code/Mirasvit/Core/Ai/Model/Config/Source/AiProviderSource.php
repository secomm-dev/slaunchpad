...
class AiProviderSource implements OptionSourceInterface
{
    ...
    public function toOptionArray(): array
    {
        ...
        foreach (ConfigProvider::AVAILABLE_PROVIDERS as $providerCode) {
            $options[] = [
                'value' => $providerCode,
                'label' => $this->getProviderLabel($providerCode),
            ];
        }
    ...
    public function getEnabledProvidersOptions(): array
    {
        $options          = [];
        $enabledProviders = $this->configProvider->getEnabledProviders();

        foreach ($enabledProviders as $providerCode) {
            $options[] = [
                'value' => $providerCode,
                'label' => $this->getProviderLabel($providerCode),
            ];
