define([
     ...
     * Secomm_AddressDropdown/js/action/billing-address-dropdown, which keeps the
    ...
    const POSTCODE_SELECTOR = '#checkout-step-billing [name="postcode"]';
    return Component.extend({
        ...
        /* TASK-FMAN1B quick-fix round 3 — same contract as the shipping copy: for VN
         * the native City field is never the entry point (wards come from the cascade
         * below the region select), so hide it regardless of cascade state. */
