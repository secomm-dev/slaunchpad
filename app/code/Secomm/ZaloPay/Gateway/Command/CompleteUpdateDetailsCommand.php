...
/**
 * CompleteUpdateDetailsCommand - for Return action (GET params)
 *
 */
class CompleteUpdateDetailsCommand implements CommandInterface
{
    /**
    ...
    /**
     * CompleteUpdateDetailsCommand constructor.
     *
