...
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\LocationDirectory;
    ...
    public function parse(
        ...
        if (count($rowData) < 5) {
            throw new RowException(
                __(
                    'The Ahamove Standard File Format is incorrect in row number "%1". Verify the format and try again.',
                    $rowNumber
                )
            );
        }
