...
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\Import;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\RateQuery;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\RateQueryFactory;

class Standard extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    /**
    ...
    {
        $this->_init('ahamove_standard', 'pk');
    }
    ...
    private function importData(array $fields, array $values)
    {
        ...
        try {
            ...
            throw new \Magento\Framework\Exception\LocalizedException(
                __('Something went wrong while importing ahamove standard.')
            );
        }
        $connection->commit();
    }
    ...
    /**
     * Upload ahamove standard file and import data from it
     *
     * @param \Magento\Framework\DataObject $object
     * @throws \Magento\Framework\Exception\LocalizedException
     * @return \Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
         ...
         */
        if (empty($_FILES['groups']['tmp_name']['ahamove']['groups']['ahamove_shipping_method']['groups']['ahamove_standard']['fields']['import']['value'])) {
            return $this;
        }
        $filePath = $_FILES['groups']['tmp_name']['ahamove']['groups']['ahamove_shipping_method']['groups']['ahamove_standard']['fields']['import']['value'];
    ...
    {
        if ($object->getData('groups/ahamove/groups/ahamove_shipping_method/groups/ahamove_standard/fields/condition_name/inherit') == '1') {
            $conditionName = (string)$this->coreConfig->getValue('carriers/ahamove_standard/condition_name', 'default');
        } else {
            $conditionName = $object->getData('groups/ahamove/groups/ahamove_shipping_method/groups/ahamove_standard/fields/condition_name/value');
        }
