 ...
 */
namespace Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Express\CSV;

use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Express\LocationDirectory;
    ...
    public function parse(
        ...
        if (count($rowData) < 5) {
            throw new RowException(
                __(
                    'The Ahamove Express File Format is incorrect in row number "%1". Verify the format and try again.',
                    $rowNumber
                )
            );
        }
