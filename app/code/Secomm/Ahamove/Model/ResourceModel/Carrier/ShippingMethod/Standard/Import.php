...
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\CSV\ColumnResolver;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\CSV\ColumnResolverFactory;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\CSV\RowException;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Standard\CSV\RowParser;
    ...
    private function getHeaders(ReadInterface $file)
    {
        ...
        if ($headers === false || count($headers) < 5) {
            throw new LocalizedException(
                __('The Ahamove Standard File Format is incorrect. Verify the format and try again.')
            );
        }
        return $headers;
    }
