...
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Express\CSV\ColumnResolver;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Express\CSV\ColumnResolverFactory;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Express\CSV\RowException;
use Secomm\Ahamove\Model\ResourceModel\Carrier\ShippingMethod\Express\CSV\RowParser;
    ...
    private function getHeaders(ReadInterface $file)
    {
        ...
        if ($headers === false || count($headers) < 5) {
            throw new LocalizedException(
                __('The Ahamove Express File Format is incorrect. Verify the format and try again.')
            );
        }
        return $headers;
    }
