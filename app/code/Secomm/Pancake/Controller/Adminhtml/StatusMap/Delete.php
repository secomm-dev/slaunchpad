...
namespace Secomm\Pancake\Controller\Adminhtml\StatusMap;
...
{
    public const ADMIN_RESOURCE = 'Secomm_Pancake::status_map';
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('Status map deleted.'));
        } catch (\Throwable) {
            $this->messageManager->addErrorMessage(__('Unable to delete status map.'));
        }
