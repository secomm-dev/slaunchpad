...
/**
 * Schema and provenance for the Generic Content B visual component.
 */
class GenericContentBDefinition extends Definition
{
    public function __construct()
    {
        parent::__construct(
            id: 'generic_content_b',
            label: 'Visual Content',
            template: 'Secomm_UiWidget::components/generic-content/b.phtml',
            group: 'content',
            schemaVersion: 1,
            fields: $this->getFieldSchema(),
            sourceComponent: 'generic-content/B-visual',
            sourceVersion: '2.8.0',
            sortOrder: 42
        );
    }
    ...
    private function getFieldSchema(): array
    {
        return [
            ...
            ['name' => 'lead', 'type' => 'textarea', 'label' => 'Lead', 'required' => true, 'max_length' => 2000],
            [
            ...
            ['name' => 'quote', 'type' => 'textarea', 'label' => 'Featured Quote', 'max_length' => 2000],
            ['name' => 'image', 'type' => 'media-image', 'label' => 'Image', 'required' => true, 'max_length' => 2048],
