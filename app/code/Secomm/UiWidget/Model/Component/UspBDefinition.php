...
/**
 * Schema and provenance for the USP B benefit cards component.
 */
class UspBDefinition extends Definition
{
    public function __construct()
    {
        parent::__construct(
            id: 'usp_b',
            label: 'Benefit Cards',
            template: 'Secomm_UiWidget::components/usp/b.phtml',
            group: 'content',
            schemaVersion: 1,
            fields: $this->getFieldSchema(),
            sourceComponent: 'usp/B-cards',
            sourceVersion: '2.8.0',
            sortOrder: 71
        );
    }
    ...
    private function getFieldSchema(): array
    {
        return [
            ...
            [
                'name' => 'items', 'type' => 'collection', 'label' => 'Benefit Cards',
