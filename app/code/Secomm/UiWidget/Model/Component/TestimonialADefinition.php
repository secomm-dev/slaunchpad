...
/**
 * Schema and provenance for the Testimonial A simple component.
 */
class TestimonialADefinition extends Definition
{
    public function __construct()
    {
        parent::__construct(
            ...
            template: 'Secomm_UiWidget::components/testimonial/a.phtml',
            group: 'content',
            schemaVersion: 1,
            fields: $this->getFieldSchema(),
            sourceComponent: 'testimonial/A-simple',
            sourceVersion: '2.8.0',
            sortOrder: 60
        );
    }
