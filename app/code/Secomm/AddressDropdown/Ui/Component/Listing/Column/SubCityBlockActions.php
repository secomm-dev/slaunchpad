 ...
 */
class SubCityBlockActions extends Column
{
    /**
     * Entity name.
     */
    protected const ENTITY_NAME = 'SubCity';

    /**
     * Url paths.
     */
    protected const VIEW_URL_PATH = 'addressdropdown/subcity/view';
    protected const EDIT_URL_PATH = 'addressdropdown/subcity/edit';
    protected const DELETE_URL_PATH = 'addressdropdown/subcity/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[SubCityInterface::SUB_CITY_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [SubCityInterface::SUB_CITY_ID => $item[SubCityInterface::SUB_CITY_ID]];
