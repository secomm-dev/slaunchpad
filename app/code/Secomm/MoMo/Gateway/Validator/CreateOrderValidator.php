<?php
/**
 * Validates the MoMo create-order response (resultCode 0 = success).
 *
 * @author    Secomm Teams
...
class CreateOrderValidator extends AbstractValidator
{
    ...
    public function validate(array $validationSubject): ResultInterface
    {
        ...
        $errorMessages = [];
        if (!$isValid) {
            $message = $response['message'] ?? 'MoMo declined the create-order request.';
            $errorMessages = [__('MoMo: %1', [$message])];
        }
