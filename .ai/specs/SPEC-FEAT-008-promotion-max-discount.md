...
Specification ID: SPEC-FEAT-008
Feature ID: FEAT-008
Specification Level: FULL

> **Status:** VALID — approved 2026-08-19 bởi user acting as TL (chat "Approved"); open decisions D1–D3 resolved theo khuyến nghị spec → [DEC-FEAT008-001](../records/decisions/DEC-FEAT008-001.md).
...
- Feature record: [FEAT-008](../records/features/FEAT-008.md)
