# Spec: TASK-2V0AEV - VN City dropdown cho admin MSI Source form

Specification ID: SPEC-TASK-2V0AEV
Feature ID: NONE
...
**Ticket reference**: [TASK-2V0AEV](../tickets/TASK-2V0AEV-apply-address-dropdown-admin-msi-source.md)
...
- VN 2-level: `region` = province, `city` = ward. Khong render `sub_city` cho Source VN (DEC-FEATE2HM1J-001).
...
|---|---|---|---|
| [DEC-FEATE2HM1J-001](../records/decisions/DEC-FEATE2HM1J-001.md) | Architecture | Accepted | VN 2-level, ward persist native city |
| DEC-FEATJSZQV3-003 / DEC-TASKYJENM2-001 | Architecture | Accepted | Generic data boundary, ward data model |
