...
- [ ] Design/mockup đính kèm (nếu UI change)
- [ ] Dependencies với requirements hoặc teams khác đã được identify
- [ ] Open questions được document với owners
- [ ] PM/BA đã review và approve requirement document
