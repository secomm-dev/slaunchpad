# Ke hoach trien khai: TASK-2V0AEV - Apply VN City dropdown tren admin MSI Source form

| Field | Value |
|---|---|
| Specification | specs/SPEC-TASK-2V0AEV-admin-vn-address-msi-source-form.md |
...
> Ticket: [TASK-2V0AEV](../tickets/TASK-2V0AEV-apply-address-dropdown-admin-msi-source.md) | Spec: [admin-vn-address-msi-source-form](../specs/SPEC-TASK-2V0AEV-admin-vn-address-msi-source-form.md)
...
| Feature | FEAT-E2HM1J |
| Workflow mode | B |
| Architecture | DEC-FEATE2HM1J-001, DEC-FEATJSZQV3-003, DEC-TASKYJENM2-001 |
...
`Secomm_VietNamAddress`, tuan DEC-FEATJSZQV3-003/025. Khong render `sub_city` cho VN.
...
- Schema `ward_id`/column moi: ngoai scope DEC-TASKYJENM2-001.
...
- TASK-4ZV5NG, TASK-SQY42T, TASK-8WSERX va storefront address surfaces.
...
- **Process correction**: Code TASK-2V0AEV da duoc them truoc plan trong turn truoc. Can TL review spec/plan va pre-review code theo plan truoc khi merge/release.
