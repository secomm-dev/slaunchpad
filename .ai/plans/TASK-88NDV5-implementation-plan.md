# Implementation Plan: TASK-88NDV5 — Hyvä-native AddressDropdown (MODULE layer)

| Field | Value |
|---|---|
| Specification | specs/addressdropdown-hyva.md |

> ⚠️ **LEGACY (Phase 1a) — superseded by [`records/features/FEAT-YVN39K.md`](../records/features/FEAT-YVN39K.md).** Read-only; excluded from default context loading; pending equivalence validation. Note: this plan (2026-07-16) is Hyva-only and **predates DEC-9** — the canonical FEAT-YVN39K reconciles the drift to dual-theme. Do not edit — update FEAT-YVN39K instead.
...
| Field | Value |
|-------|-------|
| Ticket | [TASK-88NDV5](../tickets/TASK-88NDV5-apply-hyva-theme-addressdropdown.md) |
...
> Checkout/payment regression → **KHÔNG thuộc TASK-88NDV5** (OSC ở TASK-FMAN1B).
...
- Mageplaza OSC integration → **TASK-FMAN1B**.
