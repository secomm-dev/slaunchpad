...
- `app/code/Secomm/VNPAY` (payment/IPN/signature) — requires SA review (Tier 2 escalation). High risk: custom payment gateway, signature/IPN validation, PCI-sensitive.
