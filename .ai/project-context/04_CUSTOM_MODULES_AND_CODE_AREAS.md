...
- Secomm UI component definitions/templates in `app/code/Secomm/UiWidget/`; product themes may override presentation only while IDs and schemas remain module-owned
