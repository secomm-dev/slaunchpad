# TASK-Z132WA — Spec-First governance: NO SPEC → NO IMPLEMENTATION (toolkit + project enforce)

**Legacy ID:** SL-018 *(re-identified 2026-08-20 per DEC-027; mapping: .ai/toolkit/legacy-id-map.yaml)*
...
**Author:** AI draft · **Date:** 2026-08-17 · **Status:** Dev complete *(2026-08-18: toolkit side user-implemented 47 files + AI completion — rule file, sync, backfill; 50 contract tests ALL GREEN; project validate 0 FAIL/0 WARN — chờ TL review rule wording; evidence: [TASK-Z132WA-evidence](../runtime/evidence/TASK-Z132WA/TASK-Z132WA-evidence.md))*
...
- [x] **AC-8 (Project sync + docs):** AGENTS.base §7.1/§8.2 + project AGENTS.md + rules/functions/templates/checklists/validator synced; CHANGELOG entry (i); DEC-TASKZ132WA-001 accepted trước apply; evidence file.

## Related

- Plan: [TASK-Z132WA plan](../plans/TASK-Z132WA-implementation-plan.md) · Decision: [DEC-TASKZ132WA-001](../records/decisions/DEC-TASKZ132WA-001.md) (proposed)
- Hardening kế thừa: [DEC-TASKZ132WA-002](../records/decisions/DEC-TASKZ132WA-002.md) (accepted 2026-08-19 — ticket activation contract: Mini-Spec + plan artifact bắt buộc ở tầng ticket; trigger audit TASK-3R6X8E)
