# TASK-88NDV5 — Apply Hyvä theme cho Secomm_AddressDropdown (MODULE layer)

**Legacy ID:** SL-001 *(re-identified 2026-08-20 per DEC-027; mapping: .ai/toolkit/legacy-id-map.yaml)*
...
_(OSC shipping/billing/totals AC → TASK-FMAN1B.)_
...
- (OSC/checkout-payment risk → TASK-FMAN1B, không thuộc ticket này.)
...
- **TASK-FMAN1B phụ thuộc TASK-88NDV5** (module phải expose Hyvä component/dữ liệu để Launchpad wire vào OSC).
...
- [ ] Evidence `.ai/evidence/TASK-88NDV5/`
