...
**Specification:** MINI — embedded dưới đây · canonical parent: [SPEC-FEAT-CSWYEJ](../specs/SPEC-FEAT-CSWYEJ-payment-core.md) §4.1/§4.7, AC-008→AC-012, DEC D3/D3b/D5
...
### Expected Behavior (3-layer race guard — D3)
