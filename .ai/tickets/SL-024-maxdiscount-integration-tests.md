# SL-024 — Integration tests: quote matrix (A–D) + lifecycle (E) + idempotency

**Type:** Task (slice của FEAT-008 — verification tầng system)
**Priority:** High
**Estimate:** ~16–24h
...
**Specification:** SPEC-FEAT-008 (FULL, VALID) — [spec §15 AC, §16 Test strategy, §12 Lifecycle](../specs/SPEC-FEAT-008-promotion-max-discount.md)
...
Manual QC/OSC e2e (SL-025) · performance benchmark (chỉ assert không N+1 ở unit SL-022) · multishipping đầy đủ (smoke trong SL-025 nếu TL yêu cầu).
...
- Depends: SL-022 (engine), SL-021 (schema) · Spec: [SPEC-FEAT-008](../specs/SPEC-FEAT-008-promotion-max-discount.md) §12, §15, §16 · Decision: [DEC-FEAT008-001](../records/decisions/DEC-FEAT008-001.md) §6
- QC manual: SL-025
