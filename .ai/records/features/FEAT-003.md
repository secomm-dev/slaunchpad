...
# Feature Record: Admin-configurable storefront announcement toggle
...
- Related record: FEAT-002 (broader proposal — new module `Secomm_StoreNotice` + configurable message text; remains **proposed**). FEAT-003 implements the narrower admin-toggle, reusing the existing module.
