---
id: DEC-FEATJKZM68-001
legacy_ids: [DEC-FEAT008-001]
...
supersedes: []
superseded_by:
work_items: [FEAT-JKZM68]
---

# Decision Record: Promotion Max Discount architecture (hook point, data model, redistribution, module boundary)

<!-- CANONICAL DECISION STORE. ACCEPTED 2026-08-19 — approved by user acting as TL (chat "Approved", Level 2). Naming per-work-item (Entry h): DEC-FEATJKZM68-001. -->
<!-- Index pointer: `.ai/project-context/memory/DECISIONS.md` -->
<!-- Full analysis: `.ai/specs/SPEC-FEAT-JKZM68-promotion-max-discount.md` (18 mục, verified source 2.4.8-p5). -->
...
- Decompose thành TASK-3R6X8E..TASK-HPK1WZ (spec §17); estimate SA 0.5–1d · Dev 6–8d · QC 2–3d (spec §18).

## References

- Spec: [SPEC-FEAT-JKZM68](../../specs/SPEC-FEAT-JKZM68-promotion-max-discount.md) (VALID 2026-08-19)
- Feature record: [FEAT-JKZM68](../features/FEAT-JKZM68.md)
- Tickets: TASK-3R6X8E (scaffold) · TASK-33J3RP (data model) · TASK-5H8WKE (cap engine) · TASK-67GGPR (admin UI) · TASK-4HYX6Y (integration tests) · TASK-HPK1WZ (QC + docs)
